    ...
    <main class="main-content">
        ...
        <div class="page-container">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Zelle Transfer</h1>
                    <div class="breadcrumb-text">
                        <a href="index.php">Dashboard</a> <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> International <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> Zelle
                    </div>
                </div>
            </div>
                    ...
                    <div class="payment-card-premium">
                        <div class="payment-card-header">
                            <div class="method-info">
                                <div class="method-icon-box" style="background: #f5f3ff; color: #7c3aed;">
                                    <i class="fa-solid fa-bolt-lightning"></i>
                                </div>
                                Zelle Withdrawal
                            </div>
                            <div class="text-muted small">
                                <i class="fa-solid fa-clock me-1"></i> Est: Instant - 2 Hours
                            </div>
                        </div>
                        ...
                        <form action="transactions.php">
                            ...
                            <div class="form-section">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <label class="form-label-premium">Zelle Identifier (Email/Phone)</label>
