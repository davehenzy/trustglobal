    ...
    <main class="main-content">
        ...
        <div class="page-container">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Revolut Transfer</h1>
                    <div class="breadcrumb-text">
                        <a href="index.php">Dashboard</a> <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> International <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> Revolut
                    </div>
                </div>
            </div>
                    ...
                    <div class="payment-card-premium">
                        <div class="payment-card-header">
                            <div class="method-info">
                                <div class="method-icon-box" style="background: #000; color: #fff;">
                                    <i class="fa-solid fa-rotate"></i>
                                </div>
                                Revolut Withdrawal
                            </div>
                            <div class="text-muted small">
                                <i class="fa-solid fa-clock me-1"></i> Est: 1-2 Days
                            </div>
                        </div>
                        ...
                        <form action="transactions.php">
                            ...
                            <div class="form-section">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label-premium">Phone Number / Revolut Tag</label>
                                        <div class="custom-input-group">
                                            <input type="text" placeholder="e.g. +1... or @username" required>
