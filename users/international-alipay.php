    ...
    <main class="main-content">
        ...
        <div class="page-container">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Alipay Transfer</h1>
                    <div class="breadcrumb-text">
                        <a href="index.php">Dashboard</a> <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> International <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> Alipay
                    </div>
                </div>
            </div>
                    ...
                    <div class="payment-card-premium">
                        <div class="payment-card-header">
                            <div class="method-info">
                                <div class="method-icon-box" style="background: #00a0e9; color: #fff;">
                        ...
                        <form action="transactions.php">
                            ...
                            <div class="form-section">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <label class="form-label-premium">Alipay ID</label>
                                        <div class="custom-input-group">
                                            <input type="text" placeholder="Email or Phone Number" required>
                                            <i class="fa-brands fa-alipay left-icon"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
