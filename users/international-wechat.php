    ...
    <main class="main-content">
        ...
        <div class="page-container">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">WeChat Pay Transfer</h1>
                    <div class="breadcrumb-text">
                        <a href="index.php">Dashboard</a> <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> International <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> WeChat Pay
                    </div>
                </div>
            </div>
                    ...
                    <div class="payment-card-premium">
                        <div class="payment-card-header">
                            <div class="method-info">
                                <div class="method-icon-box" style="background: #10b981; color: #fff;">
                                    <i class="fa-brands fa-weixin"></i>
                                </div>
                                WeChat Pay Withdrawal
                            </div>
                            <div class="text-muted small">
                                <i class="fa-solid fa-clock me-1"></i> Est: 24-48 Hours
                            </div>
                        </div>
                        ...
                        <form action="transactions.php">
                            ...
                            <div class="form-section">
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <label class="form-label-premium">WeChat ID</label>
                                        <div class="custom-input-group">
                                            <input type="text" placeholder="WeChat account ID" required>
                                            <i class="fa-brands fa-weixin left-icon"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
