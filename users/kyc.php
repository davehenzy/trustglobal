...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="user-profile-widget">
            ...
            <button class="btn btn-kyc active" onclick="location.href='kyc.php'"><i class="fa-solid fa-circle-exclamation"></i> Verify KYC</button>
                            ...
                            <form action="index.php">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <div class="custom-input-group">
                                            <input type="text" placeholder="123 Main St, Apt 4" required>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="custom-input-group">
                                            <input type="text" placeholder="e.g. Spouse, Parent" required>
                                ...
                                <div class="upload-zone-wrapper mt-4">
                                    <div class="row g-3">
                                        <div class="col-md-6" id="frontUploadWrapper">
                                            ...
                                            <div class="upload-zone" onclick="document.getElementById('frontInput').click()">
                                                ...
                                                <input type="file" id="frontInput" hidden accept="image/*">
                                                <div id="frontName" class="text-xs text-primary mt-2 fw-bold"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6" id="backUploadWrapper">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateUI(activeTab) {
                const docType = activeTab.innerText.trim();
                if (docType === 'Intl Passport') {
                    backWrapper.style.display = 'none';
                    frontWrapper.className = 'col-12';
            ...
            // Initial UI update
            updateUI(document.querySelector('.upload-tab.active'));

            // File display logic
            ['front', 'back'].forEach(side => {
                const input = document.getElementById(side + 'Input');
                const nameDisplay = document.getElementById(side + 'Name');
