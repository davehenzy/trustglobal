    ...
    <main class="main-content">
        ...
        <div class="page-container">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Wise Transfer</h1>
                    <div class="breadcrumb-text">
                        <a href="index.php">Dashboard</a> <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> International <i class="fa-solid fa-chevron-right mx-2" style="font-size: 0.7rem;"></i> Wise
                    </div>
                </div>
            </div>
                    ...
                    <div class="payment-card-premium">
                        <div class="payment-card-header">
                            <div class="method-info">
                                ...
                                Wise Transfer Withdrawal
                            </div>
                            <div class="text-muted small">
                                <i class="fa-solid fa-clock me-1"></i> Est: 1-2 Business Days
                            </div>
                        </div>
                            ...
                            <div class="form-section">
                                <div class="row g-4 mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="custom-input-group">
                                            <input type="email" placeholder="Associated with Wise" required>
                                ...
                                <button type="submit" class="btn-submit-premium">
                                    <i class="fa-solid fa-paper-plane"></i> Initialize Wise Transfer
                                </button>

                                <div class="secure-badge">
                                    <i class="fa-solid fa-shield-check"></i>
                                    <p>Your transfer is protected by SwiftCapital's advanced security system. Wise transfers are fast and low-fee.</p>
                                </div>
                            </div>
                        </form>
                    </div>
