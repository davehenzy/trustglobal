    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 relative overflow-hidden">
        ...
        <div class="relative flex flex-col justify-center items-center w-full h-full text-white p-12 z-10">
            ...
            <p class="text-xl mb-8 max-w-md text-center text-white/80">
                Secure access to your SwiftCapital account with our simple password recovery process.
            </p>
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 lg:p-12">
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <!-- Password Reset Form -->
                <div class="px-8 pb-8">
                    <form method="POST" action="http://trustsglobal.com/forgot-password">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="input-wrapper">
                                <div class="relative">
                                    ...
                                    <input id="email" type="email" name="email" value="" class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500" placeholder="name@email.com" required="" autocomplete="email">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col space-y-4">
                            ...
                            <a href="logout.php" class="w-full py-3 px-4 bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium rounded-lg transition duration-150 ease-in-out flex items-center justify-center">
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-600">
                    &copy; 2026 SwiftCapital. All Rights Reserved.
                </p>
            </div>
        </div>
    </div>
